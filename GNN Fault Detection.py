...
if __name__ == "__main__":
    ...
    # Testing
    file_paths = ['test_dataset1.csv', 'test_dataset2.csv', 'test_dataset3.csv', 'test_dataset4.csv', 'test_dataset5.csv','test_dataset6.csv','test_dataset7.csv','test_dataset8.csv','test_dataset9.csv','test_dataset10.csv']
